<template>
    <div class="chart-page">
        <slideTab :hasAdd="false" :listData="personlistData">
            <li slot="slideLi" @click="changeList(item,index)" v-for="(item,index) in personlistData" :key="index" :class="{'active': index == tabNum}">
        ...
        <div class="chart-video" :class="[isVideoState?'':'chart-editPhoto']" v-show = "isShowVideo">
            ...
            <div class="chart-video_photo">
                <ul :style="{height:(screenHeight-48)+'px'}">
                    <li :class="[item.isSelf?'self-photo':'']" v-for="(item,idx) in videoMes" :key="idx">
