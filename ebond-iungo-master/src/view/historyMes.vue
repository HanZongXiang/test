  ...
  <div class="historyMes">
                  ...
                  <li v-for="(item,index) in tableList" :key="index">
                      ...
                      <div class="medical-state" v-show="item.stateDeatilVisible">
                          ...
                          <ul class="medical-stateBoxP stripe" v-if="item.mesType == '1'">
                              <li v-for="(sick,idx) in item.newSickPerson" :key="idx" v-if="!sick.isDetail">{{sick.title}}<span>{{sick.value}}</span></li>
                          ...
                          <ul class="medical-stateBoxP stripe" v-if="item.mesType == '2'">
                              <li v-for="(sick,idx) in item.newSickPerson" :key="idx" v-if="!sick.isDetail">{{sick.title}}<span>{{sick.value}}</span></li>
                              <li class="medical-stateBoxP_table" v-for="(sick,idx) in item.newSickPerson" :key="idx" v-if="sick.isDetail">
                                  <p>{{sick.title}}</p>
                                  <table>
                                      <thead>
                                      <tr>
                                      ...
                                      <tbody>
                                      <tr v-for="(td,idx) in sick.value" :key="idx">
                                          <td>{{td.itemName}}</td>
                          ...
                          <ul class="medical-stateBoxP stripe" v-if="item.mesType == '4'">
                              <li v-for="(sick,idx) in item.transferResult" :key="idx">{{sick.title}}<span :class="sick.isBotton ? 'col_green':''">{{sick.value}}</span></li>
                          ...
                          <ul class="medical-stateBoxLine" v-if="item.mesType == '3'">
                              <li v-for="(sick,idx) in item.personInfor" :key="idx">{{sick.title}}<span>{{sick.value}}</span></li>
                          </ul>
                          <ul class="medical-stateBoxP stripe" v-if="item.mesType == '3'">
                              <li v-for="(sick,idx) in item.transferApply" :key="idx">{{sick.title}}<span :class="sick.isBotton ? 'col_green':''">{{sick.value}}</span></li>
     ...
     <div class="personList-content" v-else>
          ...
          <div class="personList-detail" v-if="buttonActive && !isEditDetail">
              <!--信息展示 start-->
              <ul>
                  <li v-for="(item,index) in personDetail.personInfor" :key="index">{{item.title}}<span>{{item.value}}</span></li>
              </ul>
              <!--信息展示 end-->
          ...
          <div class="personList-items" v-else>
              <div class="medical-table">
                  ...
                  <ul class="medical-table_list marginTop_0 marginBottom_0" :style="{'max-height':warpDetailHeight+'px'}">
                      <li v-for="(item,index) in tableListHistory" :key="index">
                          <!--list列表-->
                          ...
                          <div class="medical-state" v-show="item.stateDeatilVisible">
                              ...
                              <ul class="medical-stateBoxP stripe" v-if="item.finishType == '2'">
                                  <li v-for="(sick,idx) in item.itemsDetail" :key="idx">{{sick.title}}<span :class="sick.isBotton ? 'col_green':''">{{sick.value}}</span></li>
                                  <span class="medical-state_btnGroud">
