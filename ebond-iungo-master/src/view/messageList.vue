        ...
        <li v-for="(item,index) in tableList" :key="index">
          ...
          <div class="medical-state" v-show="item.stateDeatilVisible">
            ...
            <ul class="medical-stateBoxP stripe" v-if="item.mesType == '1'">
              <li v-for="(sick,index) in item.newSickPerson" v-if="!sick.isDetail" :key="index">{{sick.title}}<span>{{sick.value}}</span></li>
            ...
            <ul class="medical-stateBoxP stripe" v-if="item.mesType == '2'">
              <li v-for="(sick,index) in item.newSickPerson" v-if="!sick.isDetail" :key="index">{{sick.title}}<span>{{sick.value}}</span></li>
              <li class="medical-stateBoxP_table" v-for="(sick,index) in item.newSickPerson" v-if="sick.isDetail" :key="index">
                <p>{{sick.title}}</p>
                <table>
                  <thead>
                  <tr>
                  ...
                  <tbody>
                  <tr v-for="(td,index) in sick.value" :key="index">
                    <td>{{td.itemName}}</td>
            ...
            <ul class="medical-stateBoxLine" v-if="item.mesType == '3'">
              <li v-for="(sick,index) in item.personInfor" :key="index">{{sick.title}}<span>{{sick.value}}</span></li>
            </ul>
            <ul class="medical-stateBoxP stripe" v-if="item.mesType == '3'">
              <li v-for="(sick,index) in item.transferApply" :key="index">{{sick.title}}<span :class="sick.isBotton ? 'col_green':''">{{sick.value}}</span></li>
            ...
            <ul class="medical-stateBoxP stripe" v-if="item.mesType == '4'">
              <li v-for="(sick,index) in item.transferResult" :key="index">{{sick.title}}<span :class="sick.isBotton ? 'col_green':''">{{sick.value}}</span></li>
