  ...
  <div class="medical-page">
    <div class="medical-page_silde" ref="pageSilde" :class="{'silde-collapse':collapse}" :style="{'z-index': isFristLogin?'auto':''}">
      ...
      <div class="medical-page_head">
        ...
        <el-popover
              ...
              <el-row :gutter="20">
                  ...
                  <el-col :span="8" v-for="(item,index) in person.personMes" :key="index">
      ...
      <ul class="medical-page_menu el-menu">
          <li class="el-menu-item" :class="{'is-active':$route.path == item.path}" v-for="(item,index) in routesOptions" :key="index" @click="linkTo(item)">
